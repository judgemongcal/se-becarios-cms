...
function ActivityFilters() {
  return (
    <div className=" mt-2 flex flex-row justify-around gap-3 md:gap-5">
      ...
      <button className="filter-posts bg-brand-input rounded-8 shadow-shadow-db hover:bg-brand-yellow inline-flex flex-row items-center justify-center px-3 duration-300">
        <p className="text-[0.75rem]  font-semibold md:px-3 md:text-[1rem]">
          Post Activities
        </p>
      </button>
      <button className="filter-edits bg-brand-input rounded-8 shadow-shadow-db hover:bg-brand-yellow inline-flex flex-row items-center justify-center px-3  duration-300">
        <p className="text-[0.75rem]  font-semibold md:px-3 md:text-[1rem]">
          Edit Activities
        </p>
      </button>
      <button className="filter-delete bg-brand-input rounded-8 shadow-shadow-db hover:bg-brand-yellow inline-flex flex-row items-center justify-center px-3  duration-300">
        <p className="text-[0.75rem] font-semibold md:px-3 md:text-[1rem]">
          Delete Activities
        </p>
      </button>
